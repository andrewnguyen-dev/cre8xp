...
const HighPerformanceTravel = () => {
  ...
  return (
    <section className="text-pri font-manrope">
      ...
      <div ref={img1Ref} className="grid h-screen grid-cols-1 gap-8 bg-white md:grid-cols-3">
        <div className="relative order-2 col-span-2 h-auto w-full overflow-hidden md:order-1">
          <motion.div
            ...
            className="relative h-full w-full"
          >
            <Image src="/2.jpg" alt="High Performance Travel" fill className="object-cover" />
          </motion.div>
        </div>
        <div className="my-auto px-10 sm:px-16 order-1 md:order-2">
          <FadeInText fromY={10}>
            <h2>Our Promise</h2>
          </FadeInText>
      ...
      <div className="bg-sec">
        <div className="mx-8 py-36 sm:mx-auto sm:w-2/3">
          ...
          <ul id="our-fully-integrated-approach" className="space-y-2">
            ...
            <li>
              <strong>Professional Growth &amp; Recognition:</strong> Gain micro-credentialing, badges, and access to
      ...
      <div className="bg-white">
        <div className="mx-8 py-36 sm:mx-auto sm:w-2/3">
          ...
          <p>
            ...
            Through world-class facilities, expert-led sessions, and exclusive access to high-performance environments,
            we provide a transformational journey that reshapes leadership, teamwork, and personal growth.
          </p>
